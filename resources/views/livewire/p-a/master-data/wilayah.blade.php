                            ...
                            <form wire:submit.prevent="filter()" class="p-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Cari Jenis..."
                                        wire:model.defer="filterWilayah">
                                </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan nama wilayah"
                                wire:model.defer="nama_wilayah">
                            @error('nama_wilayah')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group mb-3">
                            <input type="hidden" wire:model.defer="wilayahId">
                            <label class="form-label">Nama Wilayah</label>
                            <input type="text" class="form-control" wire:model.defer="nama_wilayah"
                                placeholder="Masukan Nama Wilayah" value="{{ $nama_wilayah }}">
                            @error('nama_wilayah')
