                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <div class="position-relative d-flex justify-content-center">
                                ...
                                @elseif($thumbPrev)
                                    <img class="img img-thumbnail" style="width:300px; height:300px;object-fit:contain;"
                                        src="{{ asset('/storage/images/thumbnail/original/' . $thumbPrev) }}">
                                @else
                        ...
                        @if ($thumbPrev != null)
                            <div class="d-flex justify-content-center">
                                <button type="button" class="btn btn-sm btn-danger"
                                    wire:click.prevent="confirmDeleteThumbnail()">
                            ...
                            @if ($lampiranPrev)
                                <div class="mt-3">
                                    <ul class="list-group list-group-flush">
                                        @foreach ($lampiranPrev as $key => $lmpr)
                                            <li class="list-group-item">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="flex-grow-1">
                                                        <a href="{{ asset('storage/lampiran/' . $lmpr) }}"
                                                    ...
                                                    <div class="">
                                                        <button class="btn btn-outline-danger" title="Hapus Lampiran"
                                                            wire:click.prevent="confirmDeleteLampiran('{{ $key }}')">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" wire:model.defer="judul_halaman"
                                        class="form-control @error('judul_halaman') is-invalid @enderror"
                                        placeholder="Masukkan Judul Halaman" value="{{ $judul_halaman }}"
                                        autocomplete="off">
                                    @error('judul_halaman')
                                        <span class="invalid-feedback d-block">
                                            {{ $message }}
