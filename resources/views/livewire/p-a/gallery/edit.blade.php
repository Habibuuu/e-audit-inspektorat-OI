                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="thumbnail">
                                    <div class="thumb" style="position: relative;">
                                        <a href="{{ asset('storage/gallery/' . $image->image) }}" data-lightbox="1"
                                            data-title="{{ $judul }}">
                                            <img src="{{ asset('storage/gallery/' . $image->image) }}" alt="image"
                                                class="img-fluid img-thumbnail img-container mb-4"
                                                style="height:250px; object-fit: contain">
                                        </a>
                                        <button class="btn btn-danger shadow" title="Hapus Photo"
                                            style="position: absolute; bottom:30px; right:15px; z-index:999;padding:7px"
