    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <h5>{{ $penerima }}</h5>
                                <span class="badge-pill badge-primary"
                                    style="background-color: grey;font-size:10px;">{{ Carbon::parse($updated_at)->isoFormat('DD MMMM YYYY') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-9">
                ...
                <div class="card" style="margin-bottom: 14px; border: solid 1px #7266bc; border-radius: 0.7rem;">
                    <div class="card-body">
                        @canany(['onlyAdmin', 'irban'])
                        <div class="row">
                            @if ($status == 'sudah_diverifikasi')
                            <div class="col-md-4">
                                <a href="{{ route('admin.pengaduan.verifikasi.index') }}"
                                class="btn btn-outline-warning btn-block"><i class="mdi mdi-call-missed"></i>
                                Kembali</a>
                            </div>
                            <div class="col-md-4">
                                <a href="#" wire:click="confirmVerifikasi('{{ $pengaduanId }}')"
                                class="btn btn-outline-info btn-block disabled"><i class="fa fa-check"></i>
                                Verifikasi Pengaduan</a>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-outline-danger btn-block" disabled data-toggle="modal"
                                        data-target="#updateModal" wire:click="reject({{ $pengaduanId }})"><i
                                        class="feather-x"></i> Tolak Verifikasi
                                </button>
                            </div>
                            ...
                            <div class="col-md-4">
                                <a href="#" wire:click="confirmVerifikasi('{{ $pengaduanId }}')"
                                class="btn btn-outline-info btn-block"><i class="fa fa-check"></i>
                                Verifikasi Pengaduan</a>
                            </div>
                            <div class="col-md-4">
